...
CREATE TABLE users (
  ...
  must_change_password BOOLEAN NOT NULL DEFAULT TRUE,  -- Mot de passe provisoire : changement obligatoire au prochain login
...
-- //NOTE : Utiliser uniquement en phase de développement.
INSERT INTO users (email, password_hash, display_name, must_change_password, role)
VALUES (
  'admin@example.com',
