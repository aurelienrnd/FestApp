 ...
 * @children ChangePasswordModal - La modale de changement de mot de passe, ouverte volontairement via le bouton "Modifier".
 */
export default function DashboardContent() {
  //Recuperation de l'utilisateur admin et gestion de la modale de changement de mot de passe
  const adminUser = useAdminUser();

  //initialise la modale, fermee par defaut — jamais ouverte automatiquement
  const {
